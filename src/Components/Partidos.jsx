    ...
    return (
        <>
            <div className='row mt-2 mb-5'>
                <button className='btn btn-primary btn-lg' onClick={() => generarPartidos()}><strong>GENERAR PARTIDOS</strong></button>
            </div>
            <div className='row'>
                <div>
            ...
            <div className='row mt-2 mb-5'>
                <button className='btn btn-primary btn-lg' onClick={() => generarResultados()}><strong>GENERAR RESULTADOS</strong></button>
            </div>
            <div className='row'>
